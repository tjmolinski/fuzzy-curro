 ...
 */
public class GenericTabAdapter extends FragmentPagerAdapter implements
	...
	public GenericTabAdapter(FragmentActivity activity, TabHost tabHost,
			ViewPager pager) {
	...
	public Fragment getItem(int position) {
		...
		Fragment frag = Fragment.instantiate(mContext, info.clss.getName(),
				info.args);
		// fragMap.put(position, new WeakReference<Fragment>(frag));
		return frag;
	}

	// public Fragment getFragment(int position) {
	// return fragMap.get(position).get();
	// }
